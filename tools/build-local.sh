...
cp index.html index.php og-image.php sitemap.php robots.txt app.jsx config.js \
   dianery-data.js footer.css styles.css tweaks-panel.jsx favicon.svg api.php db.php hit.php img.php upload.php migrate-images.php ai.php admin-auth.php "$OUT/"
